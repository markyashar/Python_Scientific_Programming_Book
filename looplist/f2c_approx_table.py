...
Many people use an approximate formula for quickly
converting Fahrenheit (F) to Celsius (C) degrees:
C ~= Ca = (F-30)/2
Modify the program from Exercise 2.1 so that it
prints 3 columns: F, C, and approx. value of Ca.
...
"""
Running program
Unix>python f2c_approx_table.py
F	C	Ca
